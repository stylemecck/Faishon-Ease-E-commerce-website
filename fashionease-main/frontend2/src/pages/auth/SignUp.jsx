...
function Signup() {
  ...
  return (
    ...
    <div className="flex items-center justify-center min-h-[120vh] bg-white overflow-auto hide-scrollbar">
      <motion.div 
      initial={{ opacity: 0 }}
      animate={{ opacity: 1 }}
      transition={{ duration: 0.8,delay:0.2 }}
      className="w-full max-w-md p-8 md:my-3 space-y-6 rounded-lg border border-gray-200 shadow-sm"
      >
        <motion.div
